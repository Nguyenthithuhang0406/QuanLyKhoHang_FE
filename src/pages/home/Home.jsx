                ...
                <div className='dong3_tq' >
                    ...
                    <div >
                        <div className='col3_home'>
                            ...
                            <p>Tổng số phiếu <p>52</p></p>
                        </div>
                        <div className='col3_home'>
                        <div className='icon_home'>
                        <i class="fa-solid fa-boxes-stacked"></i>
                        </div>
                        <p>Tổng lượng tồn kho <p>52,369</p></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='dong3_tq' >
                    ...
                    <div className='sub2_home'>
                        <div className='col_2_home'>
                            ...
                            <p>Xuất kho <p>cho NCC</p></p>
                        </div>
                        <div className='col_2_home'>
                            <div className='o4_home'></div>
                            <p>Xuất kho <p>cho ĐLC1</p></p>
                        </div>
                        <div className='col_2_home'>
                    ...
                    <div >
                        <div className='col3_home'>
                            ...
                            <p>Số phiếu xuất kho <p>709</p></p>
                        </div>
                        <div className='col3_home'>
                        <div className='icon_home'>
                        <i class="fa-solid fa-box-archive"></i>
                        </div>
                        <p>Tổng lượng xuất kho<p>2,238</p></p>
                        </div>
                    </div>
                </div>
            </div><div className='tongquan_home'>
                <div className='dong1_tq'>
                    <p>NHẬP KHO</p>
                </div>
                <div className='dong2_tq'>
                ...
                <div className='dong3_tq' >
                    ...
                    <div className='sub2_home'>
                        <div className='col_2_home'>
                            ...
                            <p>Nhập kho <p>từ NCC</p></p>
                        </div>
                        <div className='col_2_home'>
                            <div className='o7_home'></div>
                            <p>Nhập kho <p>từ ĐLC1</p></p>
                        </div>
                    </div>
                    <div >
                        <div className='col3_home'>
                            ...
                            <p>Số phiếu nhập kho <p>1,023</p></p>
                        </div>
                        <div className='col3_home'>
                        <div className='icon_home'>
                        <i class="fa-solid fa-box-archive"></i>                        
                        </div>
                        <p>Tổng lượng nhập kho <p>5,206</p></p>
                        </div>
                    </div>
                </div>
            </div>

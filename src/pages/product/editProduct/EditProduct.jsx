        ...
        <div className='h2_editPro'>
          ...
          <div className='sub2_editPro'>
            <div className='idpro'>
              ...
              <input className='input_editPro' type="text" name="productCode" id="mh" value={product.productCode} readOnly />
            </div>
            <div className='namepro'>
              <label htmlFor="th">Tên hàng</label>
              <input className='input_editPro' type="text" name="productName" id="th" value={product.productName} onChange={handleChange} />
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                {
                  product.productMedia && product.productMedia.map((item, index) => (
                    <div style={{ width: '200px', height: '200px', position: 'relative' }} key={index}>
                      <img src={item} alt="anh" style={{ width: '100%', height: '100%' }} />
                      <i className="fa-sharp fa-solid fa-xmark" onClick={() => handleDeleteMedia(index)} style={{position: 'absolute'}}/>
                    </div>
                  ))
                }
              </div>
            ...
            <div className='unit'>
              ...
              <br />
              <br />
              <input className='input_editPro' type="text" name="productDVT" id="dv" value={product.productDVT} onChange={handleChange}/>

            </div>
            <div className='describe_editPro'>
              <label htmlFor="mt">Mô tả hàng hóa</label><br />
              <br />
              <textarea className='mota_editpro' name='productDescription' value={product.productDescription} onChange={handleChange}/>
            </div>
            <div className='button_h3'>
              <button className='b1_inf' type="submit" onClick={handleSubmit}>Lưu</button>
              <button className='b2_inf' type="submit" onClick={handleCancel}>Hủy</button>
            </div>
          </div>
        </div>

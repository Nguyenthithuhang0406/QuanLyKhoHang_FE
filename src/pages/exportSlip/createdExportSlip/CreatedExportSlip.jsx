    ...
    <div>
      ...
      <div className="cis-body">
        <div className="cis-address">
          <span onClick={() => navigate(`/list-exportSlip/${type}`)}>
            Xuất-nhập với{" "}
        ...
        <div className="cis-addbutton">
          ...
          <button onClick={() => setShowUploadFromLocal(true)}>
            +Thêm hàng từ hệ thống
          </button>
        </div>
        <div className="cis-frame">
          <div className="cis-title">PHIẾU XUẤT KHO</div>

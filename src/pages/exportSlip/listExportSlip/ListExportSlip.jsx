        ...
        <div className="table_ListExportSlip">
          <table className="table2_ListExportSlip">
            ...
            <tr>
              ...
              <td>
                <span className="button2_ListExportSlip">Đã nhập</span>
              </td>
              <td className="purple">
                <span className="pen_ListExportSlip">
                  <i class="fa-solid fa-pen"></i>
            ...
            <tr>
              ...
              <td>
                <span className="button3_ListExportSlip">Từ chối</span>
              </td>
              <td className="purple">
                <span className="pen_ListExportSlip">
                  <i class="fa-solid fa-pen"></i>
            ...
            <tr>
              ...
              <td>
                <span className="button_ListExportSlip">Đã duyệt</span>
              </td>
              <td className="purple">
                <span className="pen_ListExportSlip">
                  <i class="fa-solid fa-pen"></i>
            ...
            <tr>
              ...
              <td>
                <span className="button4_ListExportSlip">Hoàn hàng</span>
              </td>
              <td className="purple">
                <span className="pen_ListExportSlip">
                  <i class="fa-solid fa-pen"></i>

          ...
          <Formik>
            <Form>
              ...
              <div className="register-group-field">
                ...
                <br />
                <Field className="register-Field" name="fullName" type="text" />
              ...
              <div className="register-group-field">
                ...
                <br />
                <Field className="register-Field" name="passWord" type="text" />
              ...
              <div className="register-bonus">
                <p>Bạn đã có tài khoản? <span className="register-span">  Đăng nhập</span></p>
              </div>
            </Form>
          </Formik>
        </div>
